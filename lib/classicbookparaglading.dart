...
class Classicbookparaglading extends StatefulWidget {
  const Classicbookparaglading({super.key});

  @override
  State<Classicbookparaglading> createState() => _ClassicbookparagladingState();
}

class _ClassicbookparagladingState extends State<Classicbookparaglading> {
  @override
            ...
            children: [
              ...
              Flexible(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Container(
                      width: double.infinity, // Expand content to fit the screen
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  const Color(0xffff700c), // Button background color
                              minimumSize:
                      ...
                      child: Column(
                        ...
                        children: [
                          AutoSizeText(
                            "CLASSIC PARAGLIDING",
                            style: TextStyle(
                              fontSize: deviceType == DeviceScreenType.tablet ? 32 : 45,
                              fontWeight: FontWeight.bold,
                              color: const Color(0xff2377af),
                            ),
                            textAlign: TextAlign.center,
                          ...
                          AutoSizeText(
                            "IN BIR-BILLING",
                            style: TextStyle(
                              fontSize: deviceType == DeviceScreenType.tablet ? 20 : 22,
                              color: const Color(0xff2377af),
                              letterSpacing: 3,
                              fontWeight: FontWeight.bold,
                            ),
                          ...
                          AutoSizeText(
                            "If you want a taste of what paragliding can be, the Classic flight is your gateway. This 20-minute joy flight with an experienced pilot will take you from 2500m at billing top to 1400m at the landing site in Bir.",
                            style: TextStyle(
                              fontSize: deviceType == DeviceScreenType.tablet ? 16 : 18,
                              color: Colors.black87,
                            ),
                            textAlign: TextAlign.center,
                          ),
