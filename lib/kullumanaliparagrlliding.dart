...
class Kullumanaliparagrlliding extends StatefulWidget {
  const Kullumanaliparagrlliding({super.key});

  @override
  State<Kullumanaliparagrlliding> createState() => _KullumanaliparagrllidingState();
}

class _KullumanaliparagrllidingState extends State<Kullumanaliparagrlliding> {
  @override
